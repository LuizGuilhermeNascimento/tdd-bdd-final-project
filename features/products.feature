...
Scenario: Update a Product
    ...
    And I change "Description" to "A blue baseball cap"
    And I change "Price" to "89.99"
    ...
    And I paste the "Id" field
    And I press the "Retrieve" button
    Then I should see "Baseball Cap" in the "Name" field
    And I should see "A blue baseball cap" in the "Description" field
